...
(*** In this module, we define the notion of a "quantifiable type", which is a
type that can be quantified over by quantifying over all elements of some type
in a set encoding ***)
...
Next Obligation.
  destruct a; [ reflexivity | ].
  unfold QuantType_list_obligation_1.
  set (l:= a :: a0).
  ...
  rewrite seq_nth; [ | assumption ]. f_equal.
Defined.
