...
(*one more potential roadblock (might just require equations) need to statically
  understand the return type of a call *)
...
TODO: substitution, value, small step semantics
      ...
      prove give decode_inject a sane definition (focus on removing the JMeq axiom, which is coming from the usage of dependent induction), move to denotational sep file, find way to test for correctness + 
*)
